...
HD_PWD='D:/Yannos/FILES/PROGRAMS/FPGA/VIVADO/Space_Data_Systems/Exercise_1/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_system_top.tcl
