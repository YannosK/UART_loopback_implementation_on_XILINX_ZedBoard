...
HD_PWD='D:/Yannos/FILES/PROGRAMS/FPGA/VIVADO/Space_Data_Systems/Exercise_1/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_system_top.tcl -notrace
